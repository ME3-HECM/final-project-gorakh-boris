...
//{101, 102, 103, 104, 105, 106, 107, 108, 109, 100, 101, 102, 103, 104, 105, 106, 107, 108, 109, 100};
...
unsigned char *timer_high_pointer = &trail_timer_high[19];          //0 for start of array, 19 for end of array
unsigned char *timer_low_pointer = &trail_timer_low[19];            //0 for start of array, 19 for end of array
unsigned char *manoeuvre_pointer = &trail_manoeuvre[19];            //0 for start of array, 19 for end of array
