 ...
 * Use {0}; to set ALL values of an array to zero (not just the first value)
*******************************************************************************/
unsigned char trail_timer_high[20] = {0};
unsigned char trail_timer_low[20] = {0};
unsigned char trail_manoeuvre[20] = {0};
/*******************************************************************************
 * For the pointers and counter below, 0 is start of array, 
 * 19 for end of array, 20 for one after end of array
 * 
